...
## Function physics.setAIBrakeHint(carIndex, brakeHint)
...
manually (just add a new line with it in “.vscode/settings.json”.
  ...
  2. `data`: `string|number|boolean` Data to pass to the script (will be available as `__input` value). Use `stringify()` if you need to pass something complex.
